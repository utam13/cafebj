...
const Recheckstok = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            ...
            setTimeout(() => { // Simulasi loading sebentar
                ...
                setFormData({ kdperbaikanstok: "", tgl: today, kdcabang: "", namacabang: "", kdbahanbaku: "", qty: "", satuan: "" }); // Reset form
            }, 500);
        }
    };
    ...
    const handleOpenModal = () => {
        setFormData({ kdperbaikanstok: "", tgl: today, kdcabang: "", namacabang: "", kdbahanbaku: "", qty: "", satuan: "" }); // Kosongkan form
        setSatuanOptions([]);
    ...
    const [data, setData] = useState([
        { id: 1, kdperbaikanstok: 1, tgl: "2025-03-01", kduser: 2, namauser: "User 2", kdcabang: 1, namacabang: "Cabang 1", kdbahanbaku: 1, nama: "Tepung Terigu", qty: 10, satuan: "kg", konversi: "" },
        { id: 2, kdperbaikanstok: 2, tgl: "2025-03-01", kduser: 2, namauser: "User 2", kdcabang: 2, namacabang: "Cabang 2", kdbahanbaku: 7, nama: "Krimer", qty: 20, satuan: "gram", konversi: "" },
        { id: 3, kdperbaikanstok: 3, tgl: "2025-03-01", kduser: 2, namauser: "User 2", kdcabang: 1, namacabang: "Cabang 1", kdbahanbaku: 4, nama: "Bayam", qty: 40, satuan: "ikat", konversi: "" },
        { id: 4, kdperbaikanstok: 4, tgl: "2025-03-01", kduser: 2, namauser: "User 2", kdcabang: 3, namacabang: "Cabang 3", kdbahanbaku: 5, nama: "Biji Kopi", qty: 5, satuan: "karung", konversi: "200 kg" },
        { id: 5, kdperbaikanstok: 5, tgl: "2025-03-01", kduser: 2, namauser: "User 2", kdcabang: 5, namacabang: "Cabang 5", kdbahanbaku: 3, nama: "Sirup", qty: 16, satuan: "botol", konversi: "1600 ml" },
        { id: 6, kdperbaikanstok: 6, tgl: "2025-03-01", kduser: 2, namauser: "User 2", kdcabang: 4, namacabang: "Cabang 4", kdbahanbaku: 2, nama: "Gula", qty: 51, satuan: "kg", konversi: "" },
        { id: 7, kdperbaikanstok: 7, tgl: "2025-03-01", kduser: 2, namauser: "User 2", kdcabang: 5, namacabang: "Cabang 5", kdbahanbaku: 6, nama: "Keju", qty: 37, satuan: "kotak", konversi: "" },
    ]);
    ...
    return (
        <div className="content">
            <h2>Recheck Stok <small className="fs-5">(Nama lokasi cabang)</small></h2>
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Formulir Recheck Stok</h5>
